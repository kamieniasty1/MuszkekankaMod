...
import com.kamieniasty.muszkekankamod.item.custom.EightBallItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BLUEBERRY_SEEDS = ITEMS.register("blueberry_seeds",
            () -> new ItemNameBlockItem(ModBlocks.BLUEBERRY_CROP.get(),
                    new Item.Properties().tab(ModCreativeModeTab.MUSZKEKANKA_TAB)));
    ...
    public static final RegistryObject<Item> BLUEBERRY = ITEMS.register("blueberry",
        ...
        public static final RegistryObject<Item> EIGHT_BALL = ITEMS.register("eight_ball",
                () -> new EightBallItem(new Item.Properties().tab(ModCreativeModeTab.MUSZKEKANKA_TAB).stacksTo(1)));
